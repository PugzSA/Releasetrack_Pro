...
export const AppProvider = ({ children }) => {
    ...
    const [filters, setFilters] = useState({
        tickets: { searchTerm: '', supportArea: '', type: '', priority: '', status: '' },
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            const [
                releasesData, ticketsData, metadataData, allSavedFilters,
                usersData
            ] = await Promise.all([
    ...
    const value = {
        ...
        updateMetadataItem: (id, data) => handleDataUpdate('updateMetadataItem', id, data),
