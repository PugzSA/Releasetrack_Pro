...
-- Sample releases
INSERT INTO releases (name, version, target, status, description, stakeholder_summary)
VALUES 
  ('February 2024 Release', 'v1.0', '2024-02-28', 'testing', 'Focus on automation workflow and integration improvements', 'Streamlining internal processes with automated workflows, reducing manual work by 40%'),
  ('January 2024 Release', 'v1.0', '2024-01-31', 'development', 'Monthly release including customer portal enhancements and bug fixes', 'This release will improve customer experience with new self-service capabilities and resolve 12 critical bugs reported by users');
...
VALUES 
  ('AccountPageLayout', 'Layout', 'Account', 'Modified', 'SUP-00002', 1),
  ('CaseEmailAlert', 'Workflow', 'Case', 'New', 'SUP-00001', 1),
  ('AccountValidationRule', 'ValidationRule', 'Account', 'Modified', 'SUP-00003', 2);
